...
private:
   ...
   public:
      ...
      // as long as this textblock is not allocates. Soon to be sorted
      // (should be rather short, but makes it consistent with
      // {left|right}FloatsCB.
   ...
   // allocated. Soon to be sorted, to make access faster.
