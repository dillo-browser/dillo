...
#define DBG_OBJ_MSG(aspect, prio, msg)              D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSG_O(aspect, prio, obj, msg)       D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSGF(aspect, prio, fmt, ...)        D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSGF_O(aspect, prio, obj, fmt, ...) D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSG_START()                         D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSG_START_O(obj)                    D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSG_END()                           D_STMT_START { } D_STMT_END
#define DBG_OBJ_MSG_END_O(obj)                      D_STMT_START { } D_STMT_END
#define DBG_OBJ_CREATE(klass)                       D_STMT_START { } D_STMT_END
#define DBG_OBJ_BASECLASS(klass)                    D_STMT_START { } D_STMT_END
#define DBG_OBJ_ASSOC_PARENT(parent)                D_STMT_START { } D_STMT_END
#define DBG_OBJ_ASSOC_CHILD(child)                  D_STMT_START { } D_STMT_END
#define DBG_OBJ_ASSOC(parent, child)                D_STMT_START { } D_STMT_END
#define DBG_OBJ_SET_NUM(var, val)                   D_STMT_START { } D_STMT_END
#define DBG_OBJ_SET_STR(var, val)                   D_STMT_START { } D_STMT_END
#define DBG_OBJ_SET_PTR(var, val)                   D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRSET_NUM(var, ind, val)           D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRSET_STR(var, ind, val)           D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRSET_PTR(var, ind, val)           D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRATTRSET_NUM(var, ind, attr, val) D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRATTRSET_STR(var, ind, attr, val) D_STMT_START { } D_STMT_END
#define DBG_OBJ_ARRATTRSET_PTR(var, ind, attr, val) D_STMT_START { } D_STMT_END
#define DBG_OBJ_COLOR(klass, color)                 D_STMT_START { } D_STMT_END
